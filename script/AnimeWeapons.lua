...
CurrentZoneEnemiesSignature = ""
EnemyDropdownLastAppliedSignature = ""
...
function EnemyDropdown_SetPendingValues(values)
    ...
    if not values or #CurrentZoneEnemiesCache == 0 then
        CurrentZoneEnemiesSignature = ""
    end
...
function EnemyDropdown_ApplyPendingRefresh()
    ...
    local selectedItems = BuildEnemyDropdownSelection(selectedList, CurrentZoneEnemiesCache) or {}
    EnemyDropdown.Value = selectedItems
    if EnemyDropdown.Refresh and CurrentZoneEnemiesSignature ~= EnemyDropdownLastAppliedSignature then
        EnemyDropdown:Refresh(CurrentZoneEnemiesCache)
        EnemyDropdownLastAppliedSignature = CurrentZoneEnemiesSignature
    elseif EnemyDropdown.Display then
        pcall(function() EnemyDropdown.Display() end)
    end
