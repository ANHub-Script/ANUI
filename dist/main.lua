--[[
    ...
    v1.0.252  |  2026-08-20  |  Roblox UI Library for scripts
...
VerticalAlignment=(an or(ag.ElementTable and(
ag.ElementTable.__type=="Dropdown"
or ag.ElementTable.__type=="Toggle"
)))and"Center"
