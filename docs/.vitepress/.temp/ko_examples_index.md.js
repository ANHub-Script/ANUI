...
const __pageData = JSON.parse('{"title":"Examples","description":"","frontmatter":{},"headers":[],"relativePath":"ko/examples/index.md","filePath":"ko/examples/index.md","lastUpdated":null}');
const _sfc_main = { name: "ko/examples/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("ko/examples/index.md");
