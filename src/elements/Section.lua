...
function Element:New(Config)
    ...
    local Main, MainTable = Creator.NewRoundFrame(Config.Window.ElementConfig.UICorner, "Squircle", {
        ...
        ClipsDescendants = false, -- [FIX] Mencegah isi terpotong
        AutomaticSize = "Y",
    ...
    -- [FIX] Simpan referensi Main Frame agar bisa diakses dari luar (untuk Visible = true/false)
    Section.UIElements.Main = Main 
    Section.UIElements.Top = Main.Top -- Agar header bisa disembunyikan juga
