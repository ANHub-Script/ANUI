...
return function(Config)
    local Window = {
        ...
        MinSize = Config.MinSize or Vector2.new(850, 560),
        MaxSize = Config.MaxSize or Vector2.new(1050, 560),
    ...
    function Window:SetUIScale(v)
        ...
        Tween(Config.ANUI.UIScaleObj, .2, {Scale = v}, Enum.EasingStyle.Quint, Enum.EasingDirection.Out):Play()
        return Window
    end
